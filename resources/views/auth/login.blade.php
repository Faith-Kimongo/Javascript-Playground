          ...
          <x-validation-errors class="mb-4" />
            ...
            <form class="space-y-6" action="{{ route('login') }}" method="POST">
              ...
              <div>
                ...
                <div class="mt-1">
                  <input id="email" name="email" type="email" autocomplete="email" required class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-pink-900 focus:outline-none focus:ring-pink-900 sm:text-sm">
                </div> --}}
              </div>
              ...
              <div class="flex items-center justify-between">
                {{-- <div class="flex items-center">
                  <input id="remember-me" name="remember-me" type="checkbox" class="h-4 w-4 rounded border-gray-300 text-gray-600 focus:ring-indigo-500">
                ...
                <div class="text-sm">
                  {{-- <a href="#" class="font-medium text-gray-600 hover:text-pink-900">Forgot your password?</a> --}}
              ...
              <div>
                ...
                {{-- <button type="submit" class="flex w-full justify-center rounded-md border border-transparent bg-gray-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-pink-900 focus:outline-none focus:ring-2 focus:ring-pink-900 focus:ring-offset-2">Sign in</button> --}}
              </div>
            </form>

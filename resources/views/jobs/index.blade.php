                        ...
                        <div class="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                            ...
                            <div class="flex min-w-0 flex-1 justify-between ml-3">
                                <div>
                                    ...
                                    <p class="mt-3 text-gray-600"> <span><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" style="width: 24px; height: 24px;">
                                        <path d="M12 0C7 0 3 4.25 3 9.5 3 15.25 12 24 12 24s9-8.75 9-14.5C21 4.25 17 0 12 0zm0 13c-2.25 0-4-1.75-4-4s1.75-4 4-4 4 1.75 4 4-1.75 4-4 4z" fill="#FF0000"/>
                                      </svg>
                                      </span> {{$pinned_job->location}} </p>
                                </div>

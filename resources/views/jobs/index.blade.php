                                ...
                                <div class="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                                    <div class="">
                                        <span class="h-20 w-20 rounded-full flex items-center justify-center ">
                                            ...
                                            <svg class="w-10 h-10 text-blue-600 fill-current"
                                    ...
                                    <div class="flex min-w-0 flex-1 justify-between space-x-4 ">
                                        <div>
                                            <p><a href="#" class="font-medium text-gray-900">Front End
                                                    Developer</a></p>
                ...
                <div class="shadow-2xl m-4 rounded-2xl p-6">
                    <div>
                        <div class="-ml-4 -mt-2 flex flex-wrap items-center justify-between sm:flex-nowrap">
                            <div class="ml-4 mt-2">
                                <span class="h-20 w-20 rounded-full flex items-center justify-center ">
                                    <svg height="w-10 h-10" viewBox="-101.982 -101.457 1000 1042.057" width="70"
                    ...
                    <p class="mt-4">
                        Medtronic LABS is the only health systems innovator that develops community-based, tech-enabled
                        solutions for underserved patients, families, and communities across the world. By bridging
                        hyper-local services with cutting-edge technology, LABS provides sustainable and localized
                        healthcare solutions that produce measurable patient outcomes for all.
                        <br><br>
                        Our bold approach to patient-centered health system delivery combines digital technology, field
                        operations, and implementation-focused partnerships. The technology behind our programs, SPICE,
                        is the worlds’ leading digital health platform for community-based population health.
                    </p>

                    <p class="font-semibold mt-10">Job Description</p>
                    <p class="mt-4">
                        We are seeking a skilled and experienced plumber to join our team. The ideal candidate will have
                        a strong understanding of plumbing systems, including both residential and commercial
                        applications.
                        <br><br>

        ...
        <form action="{{ route('job.store') }}" method="POST" class="mt-2">
            ...
            <div class="shadow sm:overflow-hidden sm:rounded-md">
                ...
                <div class="bg-gray-50 px-4 py-3 text-right sm:px-6">
                    <button type="submit"
                        class="inline-flex justify-center rounded-md border border-transparent bg-pink-700 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-pink-700 focus:outline-none focus:ring-2 focus:ring-pink-600 focus:ring-offset-2">Create</button>
                </div>
            </div>
        </form>
    </div>

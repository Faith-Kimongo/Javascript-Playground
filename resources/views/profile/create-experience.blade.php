            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="py-4 px-6 sm:px-10 lg:col-span-4 xl:pt-1">
                    ...
                    <form action="{{ route('experience.store') }}" method="POST"
                        class="mt-5 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        @csrf
                        <div>
                            <label for="first-name" class="block text-sm font-medium text-gray-900">Employer Name
                                </label>
                            <div class="mt-1">
                                <input type="text" name="employer_name" id="employer_name" autocomplete="given-name"
                        ...
                        <div>
                            ...
                            <div class="mt-1">
                                <input type="text" name="job_title" id="job_title" autocomplete="field"
                                    class="block w-full rounded-md border border-gray-300 py-3 px-4 text-gray-900 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
                            </div>
                        </div>
                        ...
                        <div class="relative flex items-start">
                            <div class="flex h-5 items-center">
                                <input id="status" aria-describedby="comments-description" name="status"
                                    type="checkbox"
                        ...
                        <div class="flex flex-row">
                            ...
                            <div class="sm:col-span-2 sm:flex sm:justify-end">
                                <button type="submit"
                                    class="mt-2 ml-4 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent bg-gradient-to-r from-pink-800 to-pink-900 bg-origin-border px-4 py-2 text-base font-medium text-white shadow-sm hover:from-pink-700 hover:to-pink-900">Save</button>
                            </div>
                        </div>
